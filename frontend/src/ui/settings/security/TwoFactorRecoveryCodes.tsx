  ...
  return (
    <div class="rounded-md border border-accent-yellow/30 bg-accent-yellow/[0.08] p-3 space-y-2">
      ...
      <div class="grid grid-cols-2 gap-1.5 font-mono text-[12.5px] text-ink-100">
        {codes.map((code) => (
          <div key={code} class="bg-inset border border-line rounded px-2 py-1">
            {code}
          </div>
        ))}
      </div>
      <div class="flex flex-wrap items-center gap-2">
        <button
          ...
          class="h-8 px-2.5 rounded bg-tint-strong hover:bg-tint-active text-ink-100 text-[12px] font-medium inline-flex items-center gap-1.5"
        >
        ...
        <button
          type="button"
          onClick={onDismiss}
          class="h-8 px-2.5 rounded bg-tint-strong hover:bg-tint-active text-ink-100 text-[12px] font-medium"
        >
